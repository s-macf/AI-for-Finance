...
predictions1 <- predictr(lstm_GS, x_train)
predictions2 <- predictr(lstm_GS, x_test)
draw_two_graph(predictions1, y_train, predictions2, y_test, "Train Data", "Test Data", "Grid Search Optimised Paramaters")
```

```{R fig.width=12, fig.height=4, echo=FALSE}
predictions1 <- predictr(lstm_GA, x_train)
predictions2 <- predictr(lstm_GA, x_test)
draw_two_graph(predictions1, y_train, predictions2, y_test, "Train Data", "Test Data", "Genetic Algorithm Optimised Paramaters")
```